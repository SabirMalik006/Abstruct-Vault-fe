  ...
  <div className="page-loader">
    ...
    <style>{`
      ...
      .spinner {
        width: 50px;
        height: 50px;
        border: 3px solid rgba(25, 73, 51, 0.1);
        border-top-color: #194933;
        border-radius: 50%;
            ...
            <Suspense fallback={<PageLoader />}>
              ...
              <Route path="/pages/wholesale" element={
                <div className="page-content" style={{ padding: '6rem 0', textAlign: 'center' }}>
                  ...
                  <p style={{ color: 'var(--text-muted)', marginTop: '1rem' }}>Contact us at info@horizonintegratedsolutions@gmail.com for industrial bulk orders.</p>
                </div>
              } />
