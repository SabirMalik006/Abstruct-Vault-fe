        ...
        <div className="container">
          <div className="story-grid">
            ...
            <div className="story-content">
              ...
              <p>Founded in 2020, The Abstruct Vault was established with a clear mission: to bridge the gap in Pakistan's fashion sector by providing premium, high-quality clothing and lifestyle products. What began as a specialized boutique has evolved into a leading destination for premium fashion.</p>
      ...
      <section className="team-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>The Leadership Behind The Abstruct Vault</h2>
