...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.token) {
        toast.success('Welcome back to The Abstract Vault!');
        ...
        <div className="auth-side-panel">
          ...
          <div className="side-content">
            ...
            <div className="side-text">
              ...
              <p>Join thousands of fashion lovers who trust The Abstract Vault for premium clothing and lifestyle products.</p>
            </div>
